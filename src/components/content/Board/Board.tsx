...
const Board: React.FC<BoardProps> = ({ columns }) => {
  return (
    <div className="flex flex-col flex-1 min-h-screen bg-light-gray p-6">
      {columns.length === 0 ? (
        <div className="flex flex-1 flex-col items-center justify-cente rounded-lg shadow">
        ...
        <div className="flex gap-6 overflow-x-auto">
          ...
          <button className="min-w-[280px] w-72 flex-shrink-0 flex items-center justify-center bg-gradient-to-b from-[#e9effa] to-[#f4f7fd] rounded-lg border-[#635fc7] text-[#635fc7] font-semibold hover:bg-[#d6e0ff] transition">
            + New Column
          </button>
        </div>
      )}
